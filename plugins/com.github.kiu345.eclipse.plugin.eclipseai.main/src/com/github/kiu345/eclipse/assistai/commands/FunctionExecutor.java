...
public class FunctionExecutor {
    ...
    public Method[] getFunctions() {
        return Arrays.stream(functions.getClass().getDeclaredMethods())
                .filter(method -> Objects.nonNull(method.getAnnotation(com.github.kiu345.eclipse.assistai.commands.Function.class)))
                .toArray(Method[]::new);
    }
    ...
    public CompletableFuture<Object> call(String name, Map<String, String> args) {
        ...
        method.getAnnotationsByType(com.github.kiu345.eclipse.assistai.commands.FunctionParam.class);
    ...
    public static String toParamName(Parameter parameter) {
        return Optional.ofNullable(parameter.getAnnotation(com.github.kiu345.eclipse.assistai.commands.FunctionParam.class))
    ...
    public static String toFunctionName(Method method) {
        return Optional.ofNullable(method.getAnnotation(com.github.kiu345.eclipse.assistai.commands.Function.class))
                .map(Function::name)
                .filter(Predicate.not(String::isBlank))
