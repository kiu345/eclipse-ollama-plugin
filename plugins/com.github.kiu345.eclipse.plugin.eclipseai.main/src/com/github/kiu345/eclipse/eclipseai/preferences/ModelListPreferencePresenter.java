...
import com.github.kiu345.eclipse.eclipseai.model.ModelApiDescriptor;
...
public class ModelListPreferencePresenter {
    ...
    public List<ModelApiDescriptor> getModels() {
        String modelsJson = preferenceStore.getString(PreferenceConstants.ECLIPSEAI_DEFINED_MODELS);
    ...
    public void save(List<ModelApiDescriptor> models) {
        ...
        preferenceStore.setValue(PreferenceConstants.ECLIPSEAI_DEFINED_MODELS, json);
    }
    ...
    public void onPerformDefaults() {
        preferenceStore.setToDefault(PreferenceConstants.ECLIPSEAI_DEFINED_MODELS);
        view.showModels(getModels());
        view.clearModelDetails();
    }
}
