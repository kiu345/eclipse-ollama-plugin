...
public class IDETools {
    ...
    @Tool(
        "Opens a new compare view in the IDE which shows two text elements to each other. Input needs to be well formatted with whitespaces and newlines. Do NOT call for fragments of code or other tasks."
    )
