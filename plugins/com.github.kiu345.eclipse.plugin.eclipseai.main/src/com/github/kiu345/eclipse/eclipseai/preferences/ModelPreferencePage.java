...
//        ComboFieldEditor modelSelector = new ComboFieldEditor(PreferenceConstants.ECLIPSEAI_SELECTED_MODEL, "&Selected Model:", entries, getFieldEditorParent());
//        addField(modelSelector);

        addField(
                new IntegerFieldEditor(
                        PreferenceConstants.ECLIPSEAI_CONNECTION_TIMEOUT_SECONDS, "Connect timeout:", getFieldEditorParent()
                )
        );

        addField(
                new IntegerFieldEditor(
                        PreferenceConstants.ECLIPSEAI_REQUEST_TIMEOUT_SECONDS, "Request timeout:", getFieldEditorParent()
                )
        );

        addField(
                new StringFieldEditor(
                        PreferenceConstants.ECLIPSEAI_BASE_URL, "Base URL:", getFieldEditorParent()
                )
        );

        addField(
                new StringFieldEditor(
                        PreferenceConstants.ECLIPSEAI_API_BASE_URL, "API base URL:", getFieldEditorParent()
                )
        );

        addField(
                new StringFieldEditor(
                        PreferenceConstants.ECLIPSEAI_GET_MODEL_API_PATH, "Model API Path:", getFieldEditorParent()
                )
        );

        addField(
                new StringFieldEditor(
                        PreferenceConstants.ECLIPSEAI_API_KEY, "API Key:", getFieldEditorParent()
                )
        );
