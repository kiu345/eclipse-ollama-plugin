...
import static com.github.kiu345.eclipse.assistai.tools.ImageUtilities.createPreview;
...
import com.github.kiu345.eclipse.assistai.handlers.AssistAIHandlerInvoker;
import com.github.kiu345.eclipse.assistai.jobs.AssistAIJobConstants;
import com.github.kiu345.eclipse.assistai.jobs.SendConversationJob;
...
import com.github.kiu345.eclipse.assistai.subscribers.AppendMessageToViewSubscriber;
...
public class ChatPresenter {
    ...
    private Preferences preferences = InstanceScope.INSTANCE.getNode("com.github.kiu345.eclipse.assistai");
...
//            messageView.setInputEnabled( true );
    ...
    private IPropertyChangeListener propChangeListener = e -> {
        if (PreferenceConstants.ASSISTAI_BASE_URL.equals(e.getProperty()) ||
                PreferenceConstants.ASSISTAI_GET_MODEL_API_PATH.equals(e.getProperty()) ||
                PreferenceConstants.ASSISTAI_API_BASE_URL.equals(e.getProperty()) ||
                PreferenceConstants.ASSISTAI_API_KEY.equals(e.getProperty())) {
            partAccessor.findMessageView().ifPresent(view -> {
                view.makeComboList();
            });
        }
